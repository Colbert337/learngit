...
public class ShowOrderDetails {
	...
	private List<RecordDetailsPara> recordDetailsPara;
	...
	public List<RecordDetailsPara> getRecordDetailsPara() {
		return recordDetailsPara;
	}
	...
	public void setRecordDetailsPara(List<RecordDetailsPara> recordDetailsPara) {
		this.recordDetailsPara = recordDetailsPara;
	}
